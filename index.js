...
bot.dialog('/askEmailId', [
    function (session) {
        botBuilder.Prompts.text(session, 'Please share your emailId so that your progress can be tracked?');
    },
    function (session, results) {
    ...
    function(session, results) {
        ...
        if (session.userData.securityCode === userEnteredSecurityCode) {
            ...
            botBuilder.Prompts.text(session,'Great, you are all setup, its time to explore JitLearning, \n Thanks for your support and hope you have a great learning experience \n Please note that the following commands will help you navigate through the learning, \n "next" : for going over the content , \n "quit" : to quit the learning module , \n "help" : to list the commands , \n Key in any command to get started');
        } else {
